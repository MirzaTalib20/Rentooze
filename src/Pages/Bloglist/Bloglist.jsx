  ...
  return (
    ...
    <div className="mainBlogpage">
      <div className="mainListingHeader bg-brand-blue w-100 position-fixed top-0 px-3 d-flex align-items-center justify-content-center px-4">
        <i
          className="fas fa-chevron-left fs-4 text-white"
          onClick={() => navigate(-3)}
        ></i>
        <h1 className="mb-0 w-100 text-white text-uppercase bricolage-bold fs-5 ps-3">
          blogs
        </h1>
        <Bottomnav />
      </div>
      ...
      <div className="blogBody container px-3 pt-5 mt-4">
        <h1 className="blogtitle fs-4 bricolage-bold">
          <span className="text-brand-blue bricolage-extrabold">
            Exploring the Benefits of Portable AC
          </span>
        </h1>
        <div className="blogImg text-center mt-4">
          <img
            src="../images/portacblog.jpg"
            alt="blog"
            className="img-fluid rounded-brand"
          />
        </div>
        ...
        <div className="blogContent mt-3">
          <p className="mb-0 text-muted lh-sm">
            {" "}
            Summer is around the corner you might be exploring different cooling
            solutions for your home or office and you might have Portable AC on
            your list then you are at the right place, this blog will help you
            make better decisions after you go through the benefits and features
            of Portable AC.
          </p>
          <div className="contentCard">
            {/* <h2 className="fs-5 mt-2 mb-0 text-brand-blue bricolage-bold">The Cool Science Behind Mist Fans</h2> */}
            <p className="text-muted lh-sm mb-0">
              Mobility - AC on wheels - Designed with mobility in mind, Portable
              AC is easy to move because of its smooth wheels under it, it is
              also lightweight and single-unit AC with an in-built compressor
              making it super convenient to handle. It can also be easily lifted
              if your house or room is upstairs.
            </p>
          </div>
          <div className="contentCard">
            <h2 className="fs-5 mt-2 mb-0 text-brand-blue bricolage-bold">
              Plug n Play no permanent installation
            </h2>
            <p className="text-muted lh-sm mb-0">
              Other traditional ACs generally need permanent installations which
              adds to the costs and needs extra effort to install the unit, Not
              the case with Portable AC you just have to plug and play, it is
              also space efficient with only having a single unit.
            </p>
          </div>
          <div className="contentCard">
            <h2 className="fs-5 mt-2 mb-0 text-brand-blue bricolage-bold">
            ...
            <p className="text-muted lh-sm mb-0">
              As the name suggests Portable ACs are not space-restricted and can
              be easily carried anywhere, It's not just portable indoors but you
              can easily carry them outdoors for your road trips, camping etc.
            </p>
          </div>
          <div className="contentCard">
            <h2 className="fs-5 mt-2 mb-0 text-brand-blue bricolage-bold">
            ...
            <p className="text-muted lh-sm mb-0">
              Compared to Traditional AC portable AC is a cheaper option with
              its low maintenance cost, less energy consumption and no
          ...
          <div className="contentCard">
            ...
            <p className="text-muted lh-sm mb-0">
              If you have a house with multiple rooms with central AC installed
              and not all the rooms of your house are occupied at the same time
              then portable AC will be the best option for you. You can easily
              shift the AC in the room you are sitting in, it will save you from
              using the central AC which is generally more energy-consuming and
              can save you a lot from your electricity bill.
            </p>
          </div>
          <div className="contentCard">
            {/* <h2 className="fs-5 mt-2 mb-0 text-brand-blue bricolage-bold">How to Choose the Best Mist Fan in Pune</h2> */}
            <p className="text-muted lh-sm mb-0">
              In the above article, we have discussed the benefits of portable
              AC but along with its benefits, it also possesses some
              disadvantages like less cooling power, noise because of the
              inbuilt compressor etc. decide on buying after considering every
              aspect and as per your convenience and need. Before going for the
              buying option you can rent the Portable AC from Rentooze.com where
              we have a variety of options which will cater for your every need.
            </p>
          </div>
          {/* <div className="contentCard">
